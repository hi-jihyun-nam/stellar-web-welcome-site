    ...
    <section className="py-32 px-6 relative bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-3">
        <svg width="100%" height="100%" className="absolute inset-0">
          ...
          <rect width="100%" height="100%" fill="url(#grid-mission)" className="text-gray-300/20" />
        </svg>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 tracking-tight leading-tight">Mission</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {missionPoints.map((point, index) => (
            <div key={index} className="group relative p-8 bg-white/80 backdrop-blur-xl border border-gray-200/60 rounded-3xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:border-gray-300/80 shadow-xl">
